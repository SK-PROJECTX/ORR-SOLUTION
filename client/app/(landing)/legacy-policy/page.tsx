              ...
              >
                ...
                <div className="flex-1 min-w-0 policy-content">
                  ...
                  <ul className="space-y-2 text-gray-300 leading-relaxed">
                    ...
                    <li>
                      <strong className="text-white">Platform</strong> — the ORR
                      Client Portal, Admin Portal, and associated digital
                      services.
                    </li>
                    <li>
                      <strong className="text-white">Consultation</strong> — a
                    ...
                    <li>
                      <strong className="text-white">Document Vault</strong> —
                    ...
                    <li>
                      <strong className="text-white">DS Discovery Stage</strong>{" "}
