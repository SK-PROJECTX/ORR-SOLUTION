					...
					<div className="grid md:grid-cols-2 gap-8">
						...
						<div className="bg-card rounded-lg p-8">
							...
							<p className="text-gray-300 mb-6">
								...
								organizations. Whether it's ensuring SOPs structuring onboarding
								workflows, or coordinating complex data management processes, we
								create functional ecosystems. Our trusted network of builders,
								engineers, and tech specialists delivers reliability from
