          ...
          <div className="max-w-3xl relative">
            ...
            <div className="bg-white p-6 grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="text-left">
                ...
                <p className="text-gray-700 text-sm leading-relaxed">
                  ORR conducted a comprehensive operational assessment, mapping all processes and identifying critical bottlenecks. We delivered a detailed optimization report that outlined workflow redesign, quality control improvements, and automation opportunities. The report included specific recommendations for process standardization, performance metrics implementation, and a phased approach to digital transformation that would maximize ROI while minimizing operational disruption.
                </p>
              </div>
              ...
              <div className="text-left">
                ...
                <p className="text-gray-700 text-sm leading-relaxed">
                  Following ORR's recommendations, the company implemented standardized processes and automated key workflows, resulting in a 35% reduction in production time and 50% fewer quality defects. The new performance monitoring system provided real-time visibility into operations, enabling proactive issue resolution. Overall operational costs decreased by 25% while customer satisfaction improved significantly due to consistent delivery times and product quality.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="absolute top-0 right-0 w-96 h-[620px] hidden lg:block -z-10">
            <div className="bg-gradient-to-br from-gray-100 to-gray-200 h-full flex items-center justify-center transform -skew-x-12">
              <Image 
                ...
                alt="Manufacturing floor with optimized processes and digital monitoring"
